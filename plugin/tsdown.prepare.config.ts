 ...
 */
export default clientBundle('dsh-tailnet-mobile-plugin', ['src/index.ts', 'src/invariant.ts'], {
  libExternal: [/^@deepseek-ai\/dsh-host-apiproxy/],
  companions: [mobileBundle('dsh-tailnet-mobile-plugin', 'src/mobile/index.tsx')],
})
